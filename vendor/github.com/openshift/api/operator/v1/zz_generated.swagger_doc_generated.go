...
var map_AWSCSIDriverConfigSpec = map[string]string{
	...
	"efsVolumeMetricsRefreshPeriod": "efsVolumeMetricsRefreshPeriod specifies the frequency, in minutes, at which volume metrics are refreshed. This field enables metric collection when set to a value greater than 0. The default refresh period in the EFS CSI driver is 240 minutes.",
	"efsVolumeMetricsFSRateLimit":   "efsVolumeMetricsFSRateLimit defines the rate limit, in goroutines per file system, for processing volume metrics. Requires efsVolumeMetricsRefreshPeriod to be set to a value greater than 0. The default rate limit set by the EFS CSI driver is 240 goroutines per file system.",
}
